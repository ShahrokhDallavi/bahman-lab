...
const Instagram = () => {
    return (
        <div>
            <div className='flex flex-col lg:flex-row justify-between items-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 lg:px-16 px-4 py-8 mx-8 md:mx-24 mb-20 rounded-xl' dir='rtl'>
