...
const Services = () => {
    return (
        <div>
            <div className="px-24 w-full lg:h-80  lg:-mt-10 bg-primaryColor mt-[-18px]">
            ...
            <div className="grid lg:grid-rows-1 grid-flow-col lg:gap-4 grid-rows-2 gap-2 pb-24 justify-center">
