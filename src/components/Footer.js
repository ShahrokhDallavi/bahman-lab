...
const Footer = () => {
    return (
        <div className="text-gray bg-[#080E20] ">
            <div className="flex flex-col justify-center items-center text-center px-24 lg:flex-row lg:text-start lg:py-12">
                ...
                <div className="flex flex-col pb-12 lg:pb-0">
                    ...
                    <p className="pb-2">آدرس: همدان-نهاوند خیابان ۱۷ شهریور- جنب داروخانه دکتر نیکومنش - ساختمان دکتر ابوالقاضی طبقه زیرین(آزمایشگاه بهمن)</p>
                    <p className="pb-2">ایمیل: bahmanlab2013@gmail.com</p>
